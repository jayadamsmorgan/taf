...
taf.test("Test JSON serialization", { "module-json" }, function()
	local test_object = {
		integer = 2,
		double = 3.14,
		another_object = {
...
taf.test("Test JSON deserialization with good string", { "module-json" }, function()
	local str = [[
    {
        "integer": 2,
        "double": 3.14,
...
taf.test("Test JSON deserialization with bad string", { "module-json" }, function()
	local str = "incorrect"
